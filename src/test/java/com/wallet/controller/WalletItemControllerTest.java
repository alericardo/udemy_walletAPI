...
import com.wallet.controller.dto.WalletItemDTO;
...
public class WalletItemControllerTest {
	...
	public void testSave() throws Exception {
		...
		BDDMockito.given(service.save(any(WalletItem.class))).willReturn(getMockWalletItem());
	...
	public void testFindBetweenDates() throws Exception {
		...
		BDDMockito.given(service.findBetweenDates(anyLong(), any(Date.class), any(Date.class), anyInt())).willReturn(page);
		BDDMockito.given(userService.findByEmail(anyString())).willReturn(Optional.of(user));
		BDDMockito.given(userWalletService.findByUsersIdAndWalletId(anyLong(), anyLong())).willReturn(Optional.of(new UserWallet()));
	...
	public void testFindByType() throws Exception {
		...
		BDDMockito.given(service.findByWalletAndType(anyLong(), any(TypeEnum.class))).willReturn(list);
	...
	public void testSumByWallet() throws Exception {
		...
		BDDMockito.given(service.sumByWalletId(anyLong())).willReturn(value);
	...
	public void testUpdate() throws Exception {
		...
		BDDMockito.given(service.findById(anyLong())).willReturn(Optional.of(getMockWalletItem()));
		BDDMockito.given(service.save(any(WalletItem.class))).willReturn(new WalletItem(1L, w, DATE, TypeEnum.SD, description, VALUE));
	...
	public void testUpdateWalletChange() throws Exception {
		...
		BDDMockito.given(service.findById(anyLong())).willReturn(Optional.of(wi));
	...
	public void testDelete() throws JsonProcessingException, Exception {
		...
		BDDMockito.given(service.findById(anyLong())).willReturn(Optional.of(new WalletItem()));
